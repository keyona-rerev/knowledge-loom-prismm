// Schedule resolver (Deno copy for edge functions).
//
// This is a byte-for-byte logic copy of src/lib/scheduleResolver.ts. The frontend
// uses that copy for the Schedule "Next publish" preview; the edge functions
// (generation stamping + publish-to-zernio) use this one. Keep the two in sync.
//
// Dependency-free: Intl + Date only, identical behavior in browser and Deno.
